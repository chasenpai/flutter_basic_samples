...
//어댑터 생성 - flutter pub run build_runner build
...
@HiveType(typeId: 1) //중복되면 안됨
class StatModel {
  @HiveField(0) //타입안에서 중복되면 안되고 변경해서도 안됨
  final double daegu;
  @HiveField(1)
  ...
  //Hive 타입으로 지정할 땐 생성자가 정의되어 있어야 한다
  StatModel({
    required this.daegu,
